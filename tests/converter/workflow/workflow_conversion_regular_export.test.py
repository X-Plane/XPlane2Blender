...
from io_xplane2blender.xplane_249_converter.xplane_249_constants import WorkflowType, WORKFLOW_REGULAR_NEW_ROOT_NAME
...
class TestWorkflowConversionRegularExport(XPlaneTestCase):
    def test_regular_conversion(self):
        ...
        new_root = objects[WORKFLOW_REGULAR_NEW_ROOT_NAME]
