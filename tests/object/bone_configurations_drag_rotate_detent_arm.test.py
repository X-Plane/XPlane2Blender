...
class TestBoneConfigurationsDragRotateDetentArm(XPlaneTestCase):
    ...
    def test_drag_rotate_detent_arm_case_02(self):
        ...
        B = create_datablock_armature(DatablockInfo("ARMATURE",name="bone_t",parent_info=ParentInfo(A,parent_type="ARMATURE"),collection="Layer 1"))
        C = create_datablock_mesh(DatablockInfo("MESH",name="bone_n",parent_info=ParentInfo(B,parent_type="ARMATURE"),collection="Layer 1"))
    ...
    def test_drag_rotate_detent_arm_case_03(self):
        ...
        A = create_datablock_armature(DatablockInfo("ARMATURE",name="bone_r",collection="Layer 1"))
        B = create_datablock_armature(DatablockInfo("ARMATURE",name="bone_n",parent_info=ParentInfo(A,parent_type="ARMATURE"),collection="Layer 1"))
        C = create_datablock_armature(DatablockInfo("ARMATURE",name="bone_n",parent_info=ParentInfo(B,parent_type="ARMATURE"),collection="Layer 1"))
        D = create_datablock_mesh(DatablockInfo("MESH",name="bone_t",        parent_info=ParentInfo(C,parent_type="ARMATURE"),collection="Layer 1"))
    ...
    def test_drag_rotate_detent_arm_case_04(self):
        ...
        B = create_datablock_armature(DatablockInfo("ARMATURE",name="bone_r",parent_info=ParentInfo(A,parent_type="ARMATURE"),collection="Layer 1"))
        C = create_datablock_armature(DatablockInfo("ARMATURE",name="bone_t",parent_info=ParentInfo(B,parent_type="ARMATURE"),collection="Layer 1"))
        D = create_datablock_mesh(DatablockInfo("MESH",name="bone_n",parent_info=ParentInfo(C,parent_type="ARMATURE"),collection="Layer 1"))
    ...
    def test_drag_rotate_detent_arm_case_05(self):
        ...
        A = create_datablock_armature(DatablockInfo("ARMATURE",name="bone_r",collection="Layer 1"))
        B = create_datablock_armature(DatablockInfo("ARMATURE",name="bone_r",parent_info=ParentInfo(A,parent_type="ARMATURE"),collection="Layer 1"))
        C = create_datablock_mesh(DatablockInfo("MESH",name="bone_t",parent_info=ParentInfo(B,parent_type="ARMATURE"),collection="Layer 1"))
    ...
    def test_drag_rotate_detent_arm_case_06(self):
        ...
        A = create_datablock_armature(DatablockInfo("ARMATURE",name="bone_r",collection="Layer 1"))
        B = create_datablock_armature(DatablockInfo("ARMATURE",name="bone_sh",parent_info=ParentInfo(A,parent_type="ARMATURE"),collection="Layer 1"))
        C = create_datablock_mesh(DatablockInfo("MESH",name="bone_t",parent_info=ParentInfo(B,parent_type="ARMATURE"),collection="Layer 1"))
    ...
    def test_drag_rotate_detent_arm_case_07(self):
        ...
        B = create_datablock_mesh(DatablockInfo("MESH",name="bone_r",parent_info=ParentInfo(A,parent_type="ARMATURE"),collection="Layer 1"))
    ...
    def test_drag_rotate_detent_arm_case_08(self):
        ...
        A = create_datablock_armature(DatablockInfo("ARMATURE",name="bone_r",collection="Layer 1"))
        B = create_datablock_mesh(DatablockInfo("MESH",name="bone_n",parent_info=ParentInfo(A,parent_type="ARMATURE"),collection="Layer 1"))
    ...
    def test_drag_rotate_detent_arm_case_12(self):
        ...
        A = create_datablock_armature(DatablockInfo("ARMATURE",name="bone_n",collection="Layer 1"))
        B = create_datablock_mesh(DatablockInfo("MESH",name="bone_t",parent_info=ParentInfo(A,parent_type="ARMATURE"),collection="Layer 1"))
    ...
    def test_drag_rotate_detent_arm_case_16(self):
        ...
        A = create_datablock_armature(DatablockInfo("ARMATURE",name="bone_r",collection="Layer 1"))
        B = create_datablock_mesh(DatablockInfo("MESH",name="bone_rt",parent_info=ParentInfo(A,parent_type="ARMATURE"),collection="Layer 1"))
    ...
    def test_drag_rotate_detent_arm_case_19(self):
        ...
        A = create_datablock_armature(DatablockInfo("ARMATURE",name="bone_r",collection="Layer 1"))
        B = create_datablock_armature(DatablockInfo("ARMATURE",name="bone_t",parent_info=ParentInfo(A,parent_type="ARMATURE"),collection="Layer 1"))
        C = create_datablock_mesh(DatablockInfo("MESH",name="bone_r",parent_info=ParentInfo(B,parent_type="ARMATURE"),collection="Layer 1"))
